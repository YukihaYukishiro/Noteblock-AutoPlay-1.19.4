...
// (LiteralArgumentBuilder) CommandManager.literal("say")
...
// ServerCommandSource serverCommandSource = (ServerCommandSource)
// context.getSource();
// PlayerManager playerManager =
// serverCommandSource.getServer().getPlayerManager();
// playerManager.broadcast((SignedMessage) message, serverCommandSource,
